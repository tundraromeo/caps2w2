...
echo "🧪 TESTING FIXED DATABASE QUERIES\n";
echo "==================================\n\n";

try {
    $conn = getDatabaseConnection();
    
    // Test 1: get_products_by_location_name query
    echo "📝 Test 1: get_products_by_location_name query\n";
    echo "----------------------------------------------\n";
    ...
    // Test 2: get_transfers_with_details query
    echo "📝 Test 2: get_transfers_with_details query\n";
    echo "-------------------------------------------\n";
    ...
    // Test 3: get_warehouse_kpis query
    echo "📝 Test 3: get_warehouse_kpis query\n";
    echo "-----------------------------------\n";
    ...
    echo "✅ Database column errors have been fixed!\n";
