    ...
    case 'get_product_batches_for_adjustment':
        try {
            ...
            $productStmt = $conn->prepare("
                SELECT p.product_id, p.product_name, p.barcode, c.category_name as category, COALESCE((SELECT SUM(fs.available_quantity) FROM tbl_fifo_stock fs WHERE fs.product_id = p.product_id), 0) as quantity,
