...
try {
    ...
    error_log("💰 RECEIPT DEBUG - Payment Method: " . ($input['paymentMethod'] ?? 'NULL'));
    error_log("💰 RECEIPT DEBUG - Amount Paid: " . ($input['amountPaid'] ?? 'NULL'));
    error_log("💰 RECEIPT DEBUG - Change: " . ($input['change'] ?? 'NULL'));
    error_log("💰 RECEIPT DEBUG - Grand Total: " . ($input['grandTotal'] ?? 'NULL'));
