...
function StoreSettings() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: theme.bg.primary }}>
      {/* Header */}
      <div className="p-6" style={{ backgroundColor: theme.bg.primary }}>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  {Object.entries(storeSettings.notifications).filter(([key]) => ['low_stock', 'expiry_alerts', 'movement_alerts'].includes(key)).map(([key, value]) => (
                    <div key={key} className="flex items-center justify-between p-4 border rounded-lg" style={{ borderColor: theme.border.default, backgroundColor: theme.bg.card }}>
                      <div>
